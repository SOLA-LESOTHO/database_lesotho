	...
	INSERT INTO source.administrative_source_type(code,display_value,status,description,is_for_registration) VALUES ('surveyReport', 'Survey Report', 'c', NULL, false);
	...
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('documentSearch', 'informationServices', 'Document Search', NULL, 'c', 1, 5.00, 0.00, 0.00, 1, NULL, NULL, NULL);
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('cancelMortBonds', 'registrationServices', 'Cancellation of Mortgage Bonds', NULL, 'c', 0, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL);
	...
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('regSpecNotBond', 'registrationServices', 'Register Special Notarial Bond', NULL, 'c', 0, 5.00, 0.00, 0.00, 0, NULL, NULL, NULL);
	...
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('foreignEntHoldTitle', 'registrationServices', 'Foreign Enterprise to Hold Title to Land', NULL, 'c', 0, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL);
	...
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('leaseTrans', 'legalServices', 'Application for Lease Transmission', NULL, 'c', 0, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL);
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('leaseSubdiv', 'legalServices', 'Register Lease Subdivision', NULL, 'c', 0, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL);
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('transmitJointLease', 'legalServices', 'Application for transmission of a Lease held Jointly', NULL, 'c', 0, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL);
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('ministrialConsent', 'registrationServices', 'Ministerial consent for foreign enterprise to hold title to land', NULL, 'c', 0, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL);
	...
	INSERT INTO application.request_type(code,request_category_code,display_value,description,status,nr_days_to_complete,base_fee,area_base_fee,value_base_fee,nr_properties_required,notation_template,rrr_type_code,type_action_code) VALUES ('regDeed', 'registrationServices', 'Register a Deed::::Ngolisa deed', NULL, 'x', 0, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL);
