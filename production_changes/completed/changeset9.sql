-- Function: application.get_work_summary(date, date)
...
ALTER FUNCTION application.get_work_summary(date, date)
  OWNER TO postgres;
COMMENT ON FUNCTION application.get_work_summary(date, date) IS 'Returns a summary of the services processed for a specified reporting period';
