-- Function: application.getresponsetime(character varying, character varying, character varying)
...
$BODY$
  ...
  COST 100
  ROWS 10000;
ALTER FUNCTION application.getresponsetime(character varying, character varying, character varying)
  OWNER TO postgres;
