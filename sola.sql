...
CREATE TABLE administrative.dispute(
    ...
    dispute_category_code varchar(40) NOT NULL,
    dispute_type_code varchar(40) NOT NULL,
...
CREATE TABLE administrative.dispute_comments(
    id varchar(50) NOT NULL,
    dispute_nr varchar(40) NOT NULL,
...
insert into application.request_type(code, request_category_code, display_value, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required) values('cadastrePrint', 'informationServices', 'Cadastre Map Print::::Stampa Catastale', 'c', 1, 0.50, 0.00, 0, 0);
...
insert into application.request_type(code, request_category_code, display_value, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, type_action_code) values('cancelProperty', 'registrationServices', 'Surrender of a lease', 'x', 5, 5, 0, 0, 1, '', 'cancel');
...
ALTER TABLE administrative.lease_condition_for_rrr ADD CONSTRAINT lease_condition_for_rrr_lease_condition_code_fk83 
            FOREIGN KEY (lease_condition_code) REFERENCES administrative.lease_condition(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX lease_condition_for_rrr_lease_condition_code_fk83_ind ON administrative.lease_condition_for_rrr (lease_condition_code);

ALTER TABLE administrative.lease_condition_for_rrr ADD CONSTRAINT lease_condition_for_rrr_rrr_id_fk84 
            FOREIGN KEY (rrr_id) REFERENCES administrative.rrr(id) ON UPDATE CASCADE ON DELETE Cascade;
CREATE INDEX lease_condition_for_rrr_rrr_id_fk84_ind ON administrative.lease_condition_for_rrr (rrr_id);
...
ALTER TABLE administrative.dispute_comments ADD CONSTRAINT dispute_comments_dispute_nr_fk87 
            FOREIGN KEY (dispute_nr) REFERENCES administrative.dispute_action(code) ON UPDATE CASCADE ON DELETE RESTRICT;
